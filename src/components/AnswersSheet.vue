...
import { getQuestionsWithAnswerCount, getAnswersForQuestion, addAnswerToQuestion } from "@/db/client.ts";
...
<template>
  <Sheet>
    <SheetTrigger as-child>
      <div v-for="question in questions" class="cursor-pointer bg-white shadow-lg hover:shadow-xl transition-shadow shadow-slate-200/50 hover:shadow-slate-200 p-4 rounded-xl w-full max-w-2xl flex items-center justify-between gap-x-4">
